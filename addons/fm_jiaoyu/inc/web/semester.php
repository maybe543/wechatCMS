 ...
 */
        ...
        if ($operation == 'display') {
            ...
            $children = array();
            $semester = pdo_fetchall("SELECT * FROM " . tablename($this->table_classify) . " WHERE weid = '{$_W['uniacid']}' And type = 'semester' And schoolid = {$schoolid} ORDER BY sid ASC, ssort DESC");
