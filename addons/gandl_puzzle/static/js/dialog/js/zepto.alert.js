;(function($, window, undefined) {
    ...
    Dialog.prototype = {
        ...
        create : function() {
             ...
             var divHeader = (this.settings.title==null)?'<div class="rDialog-header-'+ this.settings.icon +'"></div>':'<div class="rDialog-header">'+ this.settings.title +'</div>';
            
            // HTML模板
            var templates = '<div class="rDialog-wrap '+ ((this.settings.icon==null)?'':this.settings.icon) +'"><div class="rDialog-inner">' +
                                divHeader +
        ...
        cross : function() {
            ...
            $('<a>', {
				...
				_this.close();
            }).addClass('rDialog-cross').appendTo(this.dialog.find('.rDialog-wrap'));
        },
        ...
        size : function() {
            ...
            content.css({ 
                ...
                height : this.settings.height//win.height()-_this.find('.rDialog-header').height()-_this.find('.rDialog-footer').height()
            });
