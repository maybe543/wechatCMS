...
class qw_cjhdptModule extends WeModule {
	public $tablename = 'qw_cjhdpt_reply';
	...
	public function ruleDeleted($rid) {
		...
		if (!empty($replies)) {
			...
			$deleteid[] = $row['id'];
			pdo_delete("qw_cjhdpt_winner",array('aid'=>$row['id']));
			pdo_delete("qw_cjhdpt_record",array('aid'=>$row['id']));
		}
