...
$matrixPointSize = $_GET['size'] > 0 ? intval($_GET['size']) : 6;
$matrixPointmargin = $_GET['m'] > 0 ? intval($_GET['m']) : 0;
QRcode::png($value, false, $errorCorrectionLevel, $matrixPointSize, $matrixPointmargin);