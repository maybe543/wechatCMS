var activityRanking = {
    ...
    init : function(){
        activityRanking.functions.loadPersonRanking(1, function (json) {
            var tr = '';
            var baseRank = 1;
    ...
    event : function(){
        ...
        $("button.load-more").on("click", function () {
            ...
            activityRanking.functions.loadPersonRanking(page, function (json) {
                var tr = '';
                var baseRank = 1;
                if(parseInt(page) > 1){
...
$(function () {
    activityRanking.init();
    activityRanking.event();
});