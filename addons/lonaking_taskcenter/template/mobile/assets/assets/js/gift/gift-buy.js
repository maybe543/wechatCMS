...
var giftBuy = {
    ...
    event : function(){
        ...
        $$('div.pages').on('click','div.page[data-page=gift-buy] a.submit-order-info', function (e) {
            ...
            taskFramework.showPreloader('提交中...');
            ...
            $$.post(giftOrderApiUrl, postData, function (result) {
                taskFramework.hidePreloader();
                var json = JSON.parse(result);
                if(json.status == 200){
                    taskFramework.alert(json.message, function () {
                        ...
                        if(json.data.pay_redirect != '' && json.data.pay_redirect != null){
                            ...
                            $$.post(giftOrderUrl,giftOrderPostData, function (result2) {
                                ...
                                if(giftOrderJson.status == 200){
                                    var redirectUrl = '../addons/lonaking_taskcenter/template/mobile/assets/pages/gift-order-detail/my-gift-order-detail.html';
                                    if(giftOrderJson.data.mode == 1){
                                        redirectUrl = '../addons/lonaking_taskcenter/template/mobile/assets/pages/gift-order-detail/my-gift-order-detail-hongbao.html';
                                    }else if(giftOrderJson.data.mode == 2){
                                        redirectUrl = '../addons/lonaking_taskcenter/template/mobile/assets/pages/gift-order-detail/my-gift-order-detail-mobile-fee.html';
                                    }else if(giftOrderJson.data.mode == 3){
                                        redirectUrl = '../addons/lonaking_taskcenter/template/mobile/assets/pages/gift-order-detail/my-gift-order-detail.html';
                                    }else if(giftOrderJson.data.mode == 4){
                                        redirectUrl = '../addons/lonaking_taskcenter/template/mobile/assets/pages/gift-order-detail/my-gift-order-detail-ziling.html';
                                    }
