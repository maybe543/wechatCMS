...
require '../biz/QrcodeService.php';
require '../biz/Assert.php';
require '../invite/TcInviteService.php';
class TcUserService extends FlashCommonService{
    ...
    public function __construct()
    {
        ...
        $this->inviteService = new TcInviteService();
    }
