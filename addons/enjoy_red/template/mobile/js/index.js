window.onload = function() {
	...
	function share(type){
		...
		if(dialog.length==0){
			...
			$(share_dialog).addClass("dialog_share");
			$(share_dialog).html("<label></label><span></span>");
			$("#start-page").append(share_dialog);
			dialog=$(share_dialog);
    ...
    btnStart.onclick = function() {
		if(window.start_page_config.qzgz==1){
			share("gz");
		}
		else{
