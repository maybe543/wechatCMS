...
class DBUtil
{
    ...
    public static $TABLE_QMSHAKE = "mon_qmshake";
    public static $TABLE_QMSHAKE_RECORD = "mon_qmshake_record";
    public static $TABLE_QMSHAKE_PRIZE = "mon_qmshake_prize";
    public static $TABLE_QMSHAKE_USER = "mon_qmshake_user";
    public static $TABLE_QMSHAKE_SHARE = "mon_qmshake_share";
