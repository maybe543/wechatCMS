...
$tableheader = array('openID', $this->encode("昵称"),$this->encode("姓名"),$this->encode("手机号"), $this->encode($shake['udefine']),$this->encode("奖品"),$this->encode("状态"),$this->encode('中奖时间'),$this->encode('兑奖时间' ));
