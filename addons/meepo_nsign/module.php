...
class Meepo_nsignModule extends WeModule {
	...
	public function fieldsFormSubmit($rid) {
		...
		$insert = array('rid' => $rid, 'title' => $_GPC['title'], 'picture' => $_GPC['picture'], 'description' => $_GPC['description'], 'content' => htmlspecialchars_decode($_GPC['content']), );
		if (empty($id)) {
	...
	public function settingsDisplay($settings) {
		...
		load() -> func('tpl');
		if (checksubmit()) {
			$cfg = array('times' => intval($_GPC['times']), 'credit' => intval($_GPC['credit']), 'showrank' => intval($_GPC['showrank']), 'tsign' => intval($_GPC['tsign']), 'csign' => intval($_GPC['csign']), 'osign' => intval($_GPC['osign']), 'tsignprize' => $_GPC['tsignprize'], 'csignprize' => $_GPC['csignprize'], 'osignprize' => $_GPC['osignprize'], 'start_day' => $_GPC['start_day']['start'], 'end_day' => $_GPC['start_day']['end'], 'start_time' => $_GPC['start_time'], 'end_time' => $_GPC['end_time'], );
